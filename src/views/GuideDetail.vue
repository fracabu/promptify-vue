      ...
      <div v-else>
        ...
        <div class="mb-12">
          <div class="flex items-start space-x-6 mb-6">
            ...
            <div class="flex-1">
              <h1 class="text-5xl md:text-7xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-purple-600 via-blue-600 to-orange-600 dark:from-purple-400 dark:via-blue-400 dark:to-orange-400" style="font-family: 'Aldrich', sans-serif; line-height: 1.3; padding-bottom: 0.15em;">{{ getGuideTitle(guide.id) }}</h1>

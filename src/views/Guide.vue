    ...
    <main class="container mx-auto px-4 py-20">
      <section id="guide">
        ...
        <div class="text-center mb-16">
          <h1 class="text-5xl md:text-7xl font-bold mb-8 bg-clip-text text-transparent bg-gradient-to-r from-purple-600 via-blue-600 to-orange-600 dark:from-purple-400 dark:via-blue-400 dark:to-orange-400" style="font-family: 'Aldrich', sans-serif; line-height: 1.3; padding-bottom: 0.15em;">
            {{ t('guides.title') }}
          </h1>
        ...
        <div class="bg-gradient-to-r from-purple-500/10 to-blue-500/10 dark:from-purple-500/20 dark:to-blue-500/20 rounded-2xl p-8 md:p-12">
          <h2 class="text-5xl md:text-7xl font-bold mb-12 text-center bg-clip-text text-transparent bg-gradient-to-r from-purple-600 via-blue-600 to-orange-600 dark:from-purple-400 dark:via-blue-400 dark:to-orange-400" style="font-family: 'Aldrich', sans-serif; line-height: 1.3; padding-bottom: 0.15em;">
